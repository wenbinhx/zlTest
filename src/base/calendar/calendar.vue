    ...
    <div class="calendar">
        <div class="calendar-tools">
            <span class="calendar-prev" @click="prev">                
                <svg-icon class="icon-btn" icon-class="left"></svg-icon>
            </span>
            <span class="calendar-next"  @click="next">
                <svg-icon class="icon-btn" icon-class="right"></svg-icon>
            </span>
            <div class="calendar-info" @click.stop="changeYear">
                <!-- {{monthString}} -->
                <div class="month">
                    <div class="month-inner" :style="{'top':-(this.month*0.2)+'rem'}">
        ...
        <div class="calendar-years" :class="{'show':yearsShow}">
            <div v-for="y in years" class="lay-item">
                <span @click.stop="selectYear(y)" :class="{'active':y==year}">{{y}}</span>
            </div>
        </div>
...
export default {
    props: {
        ...
        weeks: {
            type: Array,
            default:function(){
                return this.$store.state.app.language == "zh" ? ['日', '一', '二', '三', '四', '五', '六'] : ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat']
            }
        },
        // 自定义月份
        months:{
            type: Array,
            default:function(){
                return this.$store.state.app.language == "zh" ? ['一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'] : ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December']
            }
        },
        // 自定义事件
        events:  {
    ...
    methods: {
        ...
        changeYear(){
            ...
            this.yearsShow=true
            this.years=[];
            for(let i=~~this.year-8;i<~~this.year+8;i++){
                this.years.push(i)
            }
        },
        selectYear(value){
